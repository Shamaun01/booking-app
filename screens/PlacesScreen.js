...
import PropertyCarts from "../components/PropertyCarts";
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 17, marginLeft: 8 }}>Sort</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{ flexDirection: "row", alignItems: "center" }}
        >
          <Ionicons name="ios-filter-outline" size={20} color="black" />
          <Text style={{ fontSize: 17, marginLeft: 8 }}>Filter</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
          ...
          style={{ flexDirection: "row", alignItems: "center" }}
        >
          <FontAwesome5 name="map-marked" size={20} color="black" />
          <Text style={{ fontSize: 17, marginLeft: 8 }}>Map</Text>
        </TouchableOpacity>
      </Pressable>
          ...
          .map((item) =>
            item.properties.map((property, index) => (
              <PropertyCarts
                ...
                children={route.params.selectChildrens}
              ...
              {filters.map((item, index) => (
                ...
                >
                  {selectedFilter.includes(item.filter) ? (
                    <FontAwesome name="circle" size={17} color="#6CB4EE" />
                  ) : (
                    <Entypo name="circle" size={17} color="black" />
                  )}

                  <Text style={{ fontSize: 15 }}> {item.filter}</Text>
                </Pressable>
              ))}
            </View>
          </View>
